...
/////////////////////////////////////////////////////////////////////////////
// proj34: Intermediate -> Injected_current with target exc
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct34 : LILMatrix<int, int> {
    ProjStruct34() : LILMatrix<int, int>( 80, 120) {
    }
    ...
    #ifdef _DEBUG
        std::cout << "ProjStruct34::init_projection() - this = " << this << std::endl;
    #endif
    ...
    void compute_psp() {
        ...
        std::cout << "    ProjStruct34::compute_psp()" << std::endl;
    #endif
        double sum;
    ...
    void update_synapse() {
    #ifdef _TRACE_SIMULATION_STEPS
        std::cout << "    ProjStruct34::update_synapse()" << std::endl;
    #endif
    ...
    double get_global_attribute_double(std::string name) {
        ...
        // should not happen
        std::cerr << "ProjStruct34::get_global_attribute_double: " << name << " not found" << std::endl;
        return 0.0;
    }
    ...
    void clear() {
    #ifdef _DEBUG
        std::cout << "ProjStruct34::clear() - this = " << this << std::endl;
    #endif
