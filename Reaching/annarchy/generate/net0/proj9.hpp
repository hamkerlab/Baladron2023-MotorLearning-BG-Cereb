...
/////////////////////////////////////////////////////////////////////////////
// proj9: Intermediate -> Intermediate with target inh
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct9 : LILMatrix<int, int> {
    ProjStruct9() : LILMatrix<int, int>( 120, 120) {
    }
    ...
    double get_global_attribute_double(std::string name) {
        ...
        // should not happen
        std::cerr << "ProjStruct9::get_global_attribute_double: " << name << " not found" << std::endl;
        return 0.0;
    }
