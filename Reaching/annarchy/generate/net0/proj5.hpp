...
/////////////////////////////////////////////////////////////////////////////
// proj5: RG_Pattern_parm4 -> RG_Pattern_parm4 with target inh
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct5 : LILMatrix<int, int> {
    ProjStruct5() : LILMatrix<int, int>( 80, 80) {
    }
    ...
    #ifdef _DEBUG
        std::cout << "ProjStruct5::init_projection() - this = " << this << std::endl;
    #endif
        ...
        if (_transmission && pop5._active){
            ...
            for (int i = 0; i < post_rank.size(); i++) {
                ...
                for (int j = 0; j < pre_rank[i].size(); j++) {
                    sum += pop5.r[pre_rank[i][j]]*w[i][j] ;
                }
                pop5._sum_inh[post_rank[i]] += sum;
            }
    ...
    std::vector<std::vector<double>> get_local_attribute_all_double(std::string name) {
        ...
        // should not happen
        std::cerr << "ProjStruct5::get_local_attribute_all_double: " << name << " not found" << std::endl;
    ...
    std::vector<double> get_local_attribute_row_double(std::string name, int rk_post) {
        ...
        // should not happen
        std::cerr << "ProjStruct5::get_local_attribute_row_double: " << name << " not found" << std::endl;
    ...
    void clear() {
    #ifdef _DEBUG
        std::cout << "ProjStruct5::clear() - this = " << this << std::endl;
    #endif
