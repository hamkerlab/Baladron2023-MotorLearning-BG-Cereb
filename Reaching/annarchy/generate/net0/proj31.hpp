...
/////////////////////////////////////////////////////////////////////////////
// proj31: Intermediate -> PF_Pattern_parm2 with target exc
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct31 : LILMatrix<int, int> {
    ProjStruct31() : LILMatrix<int, int>( 80, 120) {
    }
    ...
    #ifdef _DEBUG
        std::cout << "ProjStruct31::init_projection() - this = " << this << std::endl;
    #endif
    ...
    void compute_psp() {
        ...
        std::cout << "    ProjStruct31::compute_psp()" << std::endl;
    #endif
        double sum;
    ...
    void update_synapse() {
    #ifdef _TRACE_SIMULATION_STEPS
        std::cout << "    ProjStruct31::update_synapse()" << std::endl;
    #endif
    ...
    std::vector<std::vector<double>> get_local_attribute_all_double(std::string name) {
        ...
        // should not happen
        std::cerr << "ProjStruct31::get_local_attribute_all_double: " << name << " not found" << std::endl;
    ...
    std::vector<double> get_local_attribute_row_double(std::string name, int rk_post) {
        ...
        // should not happen
        std::cerr << "ProjStruct31::get_local_attribute_row_double: " << name << " not found" << std::endl;
    ...
    double get_local_attribute_double(std::string name, int rk_post, int rk_pre) {
        ...
        // should not happen
        std::cerr << "ProjStruct31::get_local_attribute: " << name << " not found" << std::endl;
        return 0.0;
    }
    ...
    void clear() {
    #ifdef _DEBUG
        std::cout << "ProjStruct31::clear() - this = " << this << std::endl;
    #endif
