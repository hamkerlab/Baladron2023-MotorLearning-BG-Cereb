...
/////////////////////////////////////////////////////////////////////////////
// proj22: Intermediate -> RG_Pattern_parm4 with target exc
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct22 : LILMatrix<int, int> {
    ProjStruct22() : LILMatrix<int, int>( 80, 120) {
    }
    ...
    #ifdef _DEBUG
        std::cout << "ProjStruct22::init_projection() - this = " << this << std::endl;
    #endif
    ...
    void compute_psp() {
        ...
        std::cout << "    ProjStruct22::compute_psp()" << std::endl;
    #endif
        double sum;
    ...
    void update_synapse() {
    #ifdef _TRACE_SIMULATION_STEPS
        std::cout << "    ProjStruct22::update_synapse()" << std::endl;
    #endif
    ...
    std::vector<std::vector<double>> get_local_attribute_all_double(std::string name) {
        ...
        // should not happen
        std::cerr << "ProjStruct22::get_local_attribute_all_double: " << name << " not found" << std::endl;
    ...
    std::vector<double> get_local_attribute_row_double(std::string name, int rk_post) {
        ...
        // should not happen
        std::cerr << "ProjStruct22::get_local_attribute_row_double: " << name << " not found" << std::endl;
    ...
    double get_local_attribute_double(std::string name, int rk_post, int rk_pre) {
        ...
        // should not happen
        std::cerr << "ProjStruct22::get_local_attribute: " << name << " not found" << std::endl;
        return 0.0;
    }
    ...
    void clear() {
    #ifdef _DEBUG
        std::cout << "ProjStruct22::clear() - this = " << this << std::endl;
    #endif
