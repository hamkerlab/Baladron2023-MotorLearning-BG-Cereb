...
/////////////////////////////////////////////////////////////////////////////
// proj42: StrD1_putamen -> SNr_putamen with target inh
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct42 : LILMatrix<int, int> {
    ProjStruct42() : LILMatrix<int, int>( 120, 120) {
    }
    ...
    #ifdef _DEBUG
        std::cout << "ProjStruct42::init_projection() - this = " << this << std::endl;
    #endif
    ...
    void compute_psp() {
        ...
        std::cout << "    ProjStruct42::compute_psp()" << std::endl;
    #endif
        double sum;
        ...
        if (_transmission && pop13._active){
            ...
            for (int i = 0; i < post_rank.size(); i++) {
                ...
                for (int j = 0; j < pre_rank[i].size(); j++) {
                    sum +=  pop11.r[pre_rank[i][j]]*w ;
                }
                pop13._sum_inh[post_rank[i]] += sum;
            }
    ...
    void update_synapse() {
    #ifdef _TRACE_SIMULATION_STEPS
        std::cout << "    ProjStruct42::update_synapse()" << std::endl;
    #endif
    ...
    double get_global_attribute_double(std::string name) {
        ...
        // should not happen
        std::cerr << "ProjStruct42::get_global_attribute_double: " << name << " not found" << std::endl;
        return 0.0;
    }
    ...
    void clear() {
    #ifdef _DEBUG
        std::cout << "ProjStruct42::clear() - this = " << this << std::endl;
    #endif
