...
/////////////////////////////////////////////////////////////////////////////
// proj37: Intermediate -> Injected_current with target exc
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct37 : LILMatrix<int, int> {
    ProjStruct37() : LILMatrix<int, int>( 80, 120) {
    }
    ...
    #ifdef _DEBUG
        std::cout << "ProjStruct37::init_projection() - this = " << this << std::endl;
    #endif
    ...
    void compute_psp() {
        ...
        std::cout << "    ProjStruct37::compute_psp()" << std::endl;
    #endif
        double sum;
    ...
    void update_synapse() {
    #ifdef _TRACE_SIMULATION_STEPS
        std::cout << "    ProjStruct37::update_synapse()" << std::endl;
    #endif
    ...
    double get_global_attribute_double(std::string name) {
        ...
        // should not happen
        std::cerr << "ProjStruct37::get_global_attribute_double: " << name << " not found" << std::endl;
        return 0.0;
    }
    ...
    void clear() {
    #ifdef _DEBUG
        std::cout << "ProjStruct37::clear() - this = " << this << std::endl;
    #endif
