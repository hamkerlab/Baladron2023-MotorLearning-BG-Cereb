...
/////////////////////////////////////////////////////////////////////////////
// proj47: SNc_put -> SNr_putamen with target dopa
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct47 : LILMatrix<int, int> {
    ProjStruct47() : LILMatrix<int, int>( 120, 1) {
    }
    ...
    #ifdef _DEBUG
        std::cout << "ProjStruct47::init_projection() - this = " << this << std::endl;
    #endif
    ...
    void compute_psp() {
        ...
        std::cout << "    ProjStruct47::compute_psp()" << std::endl;
    #endif
        double sum;
        ...
        if (_transmission && pop13._active){
            ...
            for (int i = 0; i < post_rank.size(); i++) {
                ...
                pop13._sum_dopa[post_rank[i]] += sum;
            }
    ...
    void update_synapse() {
    #ifdef _TRACE_SIMULATION_STEPS
        std::cout << "    ProjStruct47::update_synapse()" << std::endl;
    #endif
    ...
    double get_global_attribute_double(std::string name) {
        ...
        // should not happen
        std::cerr << "ProjStruct47::get_global_attribute_double: " << name << " not found" << std::endl;
        return 0.0;
    }
    ...
    void clear() {
    #ifdef _DEBUG
        std::cout << "ProjStruct47::clear() - this = " << this << std::endl;
    #endif
