...
/////////////////////////////////////////////////////////////////////////////
// proj46: SNc_put -> StrD1_putamen with target dopa
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct46 : LILMatrix<int, int> {
    ProjStruct46() : LILMatrix<int, int>( 120, 1) {
    }
    ...
    #ifdef _DEBUG
        std::cout << "ProjStruct46::init_projection() - this = " << this << std::endl;
    #endif
    ...
    void compute_psp() {
        ...
        std::cout << "    ProjStruct46::compute_psp()" << std::endl;
    #endif
        double sum;
        ...
        if (_transmission && pop11._active){
            ...
            for (int i = 0; i < post_rank.size(); i++) {
                ...
                for (int j = 0; j < pre_rank[i].size(); j++) {
                    sum +=  pop15.r[pre_rank[i][j]]*w ;
                }
                pop11._sum_dopa[post_rank[i]] += sum;
            }
    ...
    void update_synapse() {
    #ifdef _TRACE_SIMULATION_STEPS
        std::cout << "    ProjStruct46::update_synapse()" << std::endl;
    #endif
    ...
    double get_global_attribute_double(std::string name) {
        ...
        // should not happen
        std::cerr << "ProjStruct46::get_global_attribute_double: " << name << " not found" << std::endl;
        return 0.0;
    }
    ...
    void clear() {
    #ifdef _DEBUG
        std::cout << "ProjStruct46::clear() - this = " << this << std::endl;
    #endif
