...
///////////////////////////////////////////////////////////////
// Main Structure for the population of id 5 (RG_Pattern_parm4)
///////////////////////////////////////////////////////////////
struct PopStruct5{
    ...
    std::vector<double> get_local_attribute_all_double(std::string name) {
        ...
        // should not happen
        std::cerr << "PopStruct5::get_local_attribute_all_double: " << name << " not found" << std::endl;
    ...
    double get_local_attribute_double(std::string name, int rk) {
        ...
        // should not happen
        std::cerr << "PopStruct5::get_local_attribute_double: " << name << " not found" << std::endl;
    ...
    void set_local_attribute_all_double(std::string name, std::vector<double> value) {
        ...
        // should not happen
        std::cerr << "PopStruct5::set_local_attribute_all_double: " << name << " not found" << std::endl;
    }
    ...
    void set_local_attribute_double(std::string name, int rk, double value) {
        ...
        // should not happen
        std::cerr << "PopStruct5::set_local_attribute_double: " << name << " not found" << std::endl;
    }
    ...
    #ifdef _DEBUG
        std::cout << "PopStruct5::init_population(size="<<this->size<<") - this = " << this << std::endl;
    #endif
        _active = true;
    ...
    std::cout << "    PopStruct5::update_rng()" << std::endl;
#endif
    ...
    void update() {
        ...
        if( _active ) {
        #ifdef _TRACE_SIMULATION_STEPS
            std::cout << "    PopStruct5::update()" << std::endl;
        #endif
    ...
    void clear() {
#ifdef _DEBUG
    std::cout << "PopStruct5::clear() - this = " << this << std::endl;
#endif
        // Variables
        mp.clear();
        mp.shrink_to_fit();
