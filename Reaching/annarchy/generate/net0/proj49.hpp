...
/////////////////////////////////////////////////////////////////////////////
// proj49: pop18 -> SNc_put with target inh
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct49 : LILMatrix<int, int> {
    ProjStruct49() : LILMatrix<int, int>( 1, 1) {
    }
    ...
    #ifdef _DEBUG
        std::cout << "ProjStruct49::init_projection() - this = " << this << std::endl;
    #endif
    ...
    void compute_psp() {
        ...
        std::cout << "    ProjStruct49::compute_psp()" << std::endl;
    #endif
        double sum;
    ...
    void update_synapse() {
    #ifdef _TRACE_SIMULATION_STEPS
        std::cout << "    ProjStruct49::update_synapse()" << std::endl;
    #endif
    ...
    double get_global_attribute_double(std::string name) {
        ...
        // should not happen
        std::cerr << "ProjStruct49::get_global_attribute_double: " << name << " not found" << std::endl;
        return 0.0;
    }
    ...
    void clear() {
    #ifdef _DEBUG
        std::cout << "ProjStruct49::clear() - this = " << this << std::endl;
    #endif
