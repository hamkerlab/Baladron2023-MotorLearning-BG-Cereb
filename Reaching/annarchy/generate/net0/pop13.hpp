...
///////////////////////////////////////////////////////////////
// Main Structure for the population of id 13 (SNr_putamen)
///////////////////////////////////////////////////////////////
struct PopStruct13{
    ...
    std::vector<double> get_local_attribute_all_double(std::string name) {
        ...
        // should not happen
        std::cerr << "PopStruct13::get_local_attribute_all_double: " << name << " not found" << std::endl;
    ...
    double get_local_attribute_double(std::string name, int rk) {
        ...
        // should not happen
        std::cerr << "PopStruct13::get_local_attribute_double: " << name << " not found" << std::endl;
    ...
    void set_local_attribute_all_double(std::string name, std::vector<double> value) {
        ...
        // should not happen
        std::cerr << "PopStruct13::set_local_attribute_all_double: " << name << " not found" << std::endl;
    }
    ...
    void set_local_attribute_double(std::string name, int rk, double value) {
        ...
        // should not happen
        std::cerr << "PopStruct13::set_local_attribute_double: " << name << " not found" << std::endl;
    }
    ...
    #ifdef _DEBUG
        std::cout << "PopStruct13::init_population(size="<<this->size<<") - this = " << this << std::endl;
    #endif
        _active = true;
    ...
    std::cout << "    PopStruct13::update_rng()" << std::endl;
#endif
    ...
    void update() {
        ...
        if( _active ) {
        #ifdef _TRACE_SIMULATION_STEPS
            std::cout << "    PopStruct13::update()" << std::endl;
        #endif
    ...
    void clear() {
#ifdef _DEBUG
    std::cout << "PopStruct13::clear() - this = " << this << std::endl;
#endif
        // Variables
        mp.clear();
        mp.shrink_to_fit();
