...
/////////////////////////////////////////////////////////////////////////////
// proj35: Intermediate -> Injected_current with target exc
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct35 : LILMatrix<int, int> {
    ProjStruct35() : LILMatrix<int, int>( 80, 120) {
    }
    ...
    #ifdef _DEBUG
        std::cout << "ProjStruct35::init_projection() - this = " << this << std::endl;
    #endif
    ...
    void compute_psp() {
        ...
        std::cout << "    ProjStruct35::compute_psp()" << std::endl;
    #endif
        double sum;
        ...
        if (_transmission && pop8._active){
            ...
            for (int i = 0; i < post_rank.size(); i++) {
                ...
                for (int j = 0; j < pre_rank[i].size(); j++) {
                    sum +=  pop9.r[pre_rank[i][j]]*w ;
                }
                pop8._sum_exc[post_rank[i]] += sum;
            }
    ...
    void update_synapse() {
    #ifdef _TRACE_SIMULATION_STEPS
        std::cout << "    ProjStruct35::update_synapse()" << std::endl;
    #endif
    ...
    double get_global_attribute_double(std::string name) {
        ...
        // should not happen
        std::cerr << "ProjStruct35::get_global_attribute_double: " << name << " not found" << std::endl;
        return 0.0;
    }
    ...
    void clear() {
    #ifdef _DEBUG
        std::cout << "ProjStruct35::clear() - this = " << this << std::endl;
    #endif
