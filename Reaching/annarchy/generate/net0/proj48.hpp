...
/////////////////////////////////////////////////////////////////////////////
// proj48: pop17 -> SNc_put with target exc
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct48 : LILMatrix<int, int> {
    ProjStruct48() : LILMatrix<int, int>( 1, 1) {
    }
    ...
    #ifdef _DEBUG
        std::cout << "ProjStruct48::init_projection() - this = " << this << std::endl;
    #endif
    ...
    void compute_psp() {
        ...
        std::cout << "    ProjStruct48::compute_psp()" << std::endl;
    #endif
        double sum;
        ...
        if (_transmission && pop15._active){
            ...
            for (int i = 0; i < post_rank.size(); i++) {
                ...
                for (int j = 0; j < pre_rank[i].size(); j++) {
                    sum +=  pop17.r[pre_rank[i][j]]*w ;
                }
                pop15._sum_exc[post_rank[i]] += sum;
            }
    ...
    void update_synapse() {
    #ifdef _TRACE_SIMULATION_STEPS
        std::cout << "    ProjStruct48::update_synapse()" << std::endl;
    #endif
    ...
    double get_global_attribute_double(std::string name) {
        ...
        // should not happen
        std::cerr << "ProjStruct48::get_global_attribute_double: " << name << " not found" << std::endl;
        return 0.0;
    }
    ...
    void clear() {
    #ifdef _DEBUG
        std::cout << "ProjStruct48::clear() - this = " << this << std::endl;
    #endif
